...
const handleContactSend = async () => {
            ...
            {activeSection === "bio" && (
              <div style={{ flex: 1, overflowY: "auto", padding: 14 }}>
                ...
                <div style={{ background: "white", border: "2px inset #808080", padding: "10px 12px", fontFamily: "monospace", fontSize: 11, lineHeight: 1.9 }}>
                  <p style={{ marginBottom: 8 }}>I'm an aspiring aerospace engineer with a strong grounding in electrical engineering and software. I like working right at the boundary of hardware and software — designing embedded systems, signal-processing pipelines, and the code that makes real-world electronics actually do something useful.</p>
                  <p style={{ marginBottom: 8 }}>A lot of my work sits close to the metal: embedded C++/Python firmware, RF and wireless communications, digital signal processing, radar and sensor systems, and FPGA-based signal acquisition. I've built a computer-vision-controlled robotic hand, a mini radar system, and I contribute the Python software stack to an open-source radio-astronomy project mapping the 1.42 GHz hydrogen line across the Milky Way. Alongside the hardware I've shipped full-stack web and iOS apps that people use every day.</p><p style={{ marginBottom: 8 }}>
  I'm especially drawn to aerospace, where electrical engineering, systems design, and reliability come together to solve hard real-world problems. Outside of engineering I'm working towards obtaining my private pilot's licence, which has given me an even greater appreciation for avionics, control systems, and the engineering that makes flight possible.
                  ...
                  <p style={{ marginBottom: 8 }}>I'm currently looking for opportunities where I can contribute to ambitious projects, learn from experienced engineers, and keep developing my skills across electronics, embedded systems, and aerospace.</p>                
                  </div>
              </div>
            )}
