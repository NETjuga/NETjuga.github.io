...
const handleContactSend = async () => {
            ...
            {activeSection === "bio" && (
              <div style={{ flex: 1, overflowY: "auto", padding: 14 }}>
                ...
                <div style={{ background: "white", border: "2px inset #808080", padding: "10px 12px", fontFamily: "monospace", fontSize: 11, lineHeight: 1.9 }}>
                  <p style={{ marginBottom: 8 }}>I'm an aspiring Software engineer with 3+ years of hands-on experience building full-stack systems, shipping products, and building apps people actually use.</p>
                  <p style={{ marginBottom: 8 }}>I've built embedded systems in c++/python, deployed web apps used by people everyday, and written everything from Swift iOS apps to C++ network intrusion tools. I like making things that actually work and have utility to people.</p><p style={{ marginBottom: 8 }}>
  I'm particularly interested in the aerospace industry, where software, systems engineering, and reliability come together to solve complex real-world problems. Outside of programming, I'm currently working towards obtaining my private pilot's licence, which has given me an even greater appreciation for aviation technology and the engineering that makes flight possible.
                  ...
                  <p style={{ marginBottom: 8 }}>I'm currently looking for opportunities where I can contribute to ambitious projects, collaborate with experienced engineers, and continue developing my skills across software, systems, and product development.</p>                
                  </div>
              </div>
            )}
